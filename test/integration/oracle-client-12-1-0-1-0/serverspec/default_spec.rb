...
describe file('/tmp/kitchen/cache/oracle-client-12.1.0.1') do
  it { should be_a_directory }
  it { should be_owned_by 'oracle' }
  it { should be_grouped_into 'oracle' }
end

describe file('/tmp/kitchen/cache/oracle-client-12.1.0.1/client-12.rsp') do
  it { should be_a_file }
  it { should be_owned_by 'oracle' }
  it { should be_grouped_into 'oracle' }
...
# Oracle Client Dir
describe file('/opt/oracle/oracle-client-12.1.0.1') do
  it { should be_a_directory }
  it { should be_owned_by 'oracle' }
  it { should be_grouped_into 'oracle' }
end

describe file('/opt/oracle/oracle-client-12.1.0.1/bin/sqlplus') do
  it { should be_a_file }
  it { should be_owned_by 'oracle' }
end
